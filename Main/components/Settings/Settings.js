...
$buttonDialogAddTokenAutomatically.addEventListener('click' , async() => {
  ...
  console.log(contractinfo, "contract info")
  ...
  try {
    ...
    const wasAdded = await walletProvider.request({
      ...
      params: {
        ...
        options: {
          address: utonomaAddress, // The address that the token is at.
          symbol: utonomaSymbol, // A ticker symbol or shorthand, up to 5 chars.
